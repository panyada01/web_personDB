        ...
        <div class="row g-3">
            ...
            ?>
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <img src="images_ps/<?= $row['ps_image']; ?>" class="card-img-top" alt="..." width="800" height="300">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-success btn-flat btn-sm" href="person_frm_edit.php?act=edit&ps_id=<?php echo $row['ps_id']; ?>">
                                แก้ไข
                            </a>

                            <a class="btn btn-outline-danger" href="person_del.php?ps_id=<?= $row['ps_id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล !!');">
                                ลบ
                            </a>
