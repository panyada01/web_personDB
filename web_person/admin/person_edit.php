...
<body>
    ...
    if ($chk_edit_no == '0') {
        $sql = " UPDATE tbl_person SET ps_id='$ps_id',ps_prefix='$ps_prefix',ps_name='$ps_name',ps_surname='$ps_surname',ps_other_detail='$ps_other_detail',ps_image='$newname',occ_id='$occ_id' WHERE ps_id='$hd_ps_id' ";
