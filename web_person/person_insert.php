...
<body>
    ...
    $sql = "INSERT INTO tbl_person (ps_id,ps_prefix,ps_name,ps_surname,ps_other_detail,ps_image)VALUES ('$ps_id','$ps_prefix','$ps_name','$ps_surname','$ps_other_detail','$newname')";
